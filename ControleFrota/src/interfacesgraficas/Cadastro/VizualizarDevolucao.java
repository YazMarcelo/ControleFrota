 ...
 * @author aluno
 */
public class VizualizarDevolucao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelAcao.setText("Vizualizar Devolução");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VizualizarDevolucao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VizualizarDevolucao().setVisible(true);
            }
        });
    }
    ...
    public void pegarDados(String placa, String id, String descricao) throws Exception {
